...
function scrambleTiles() {
   for (let i = 0; i <= allTiles.length; i++) {
      ...
      // Fix bug: 
      // modify insert() to insertBefore()
      // modify to insert children[randomIndex] before children[i]
...
function playConcentration() {
   ...
   for (let i = 0; i < allTiles.length; i++) {
      ...
      allTiles[i].onclick = function() {
         ...
         // Fix bug: 
         // modify This to this
         // use condifitional operator "==" instead of assignment operator "="
         if (this.lastElementChild.className == "back") {
            ...
            if (tilesFlipped == 1) {
               ...
               // Fix bug: use 1000 instead of 1 to delay 1 second
   ...
   function flipBack() {
      ...
      // Fix bug: modify the variable name titlesFlipped to tilesFlipped
      tilesFlipped = 0;
   }   
}
