...
function quoteGenerator() {
   ...
   // Fix bug:
   // Modify the second argument "highest" from quoteCount to quoteCount - 1.
   let randomQuote = randomInt(0, quoteCount - 1);
   
   // Retrieve a randomly-selected quote
   // Fix bug:
   // Modify the variable name randomQuotes to randomQuote.
   let quote = quotes[randomQuote];
   
   // Display the random quote
   // Fix bug: 
   // Modify the method name getElementByTagName() to getElementsByTagName().
   // Modify the array index from 1 to 0.
