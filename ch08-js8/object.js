...
/* // Use new Object() method instead of object literal
...
function pokerCard(cardSuit, cardRank) {
   ...
   // use non-prototype to define the method
...
let cardGame = {
   ...
   creators: {
      ...
      programmers: ["Tom Devian", "Chanda Bhasin"]
   },
   yearCreated: 2024,
   lastRevised: null
};
...
let card2 = new pokerCard("spades", "y");
myDeck.card[3]
...
let myUno = new UnoCard("8 green");
pokerCard.prototype.showRank.apply(myUno);
